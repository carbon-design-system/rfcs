...
[Active RFC List](https://github.com/carbon-design-system/rfcs/pulls)
...
from an RFC are:
   ...
   - The introduction of new idiomatic usage or conventions, even if they
     do not include code changes to Carbon itself.
...
* Fork the RFC repo http://github.com/carbon-design-system/rfcs
